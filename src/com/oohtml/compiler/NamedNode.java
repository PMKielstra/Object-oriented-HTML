...
/**
 * A class used for documents, sub-documents, and elements. This class is quite
 * versatile and can be used for pretty much any HTML out there.
 */
public class NamedNode {
	...
	/**
	 * The constructor used for non-document nodes. It gives the path a final
	 * value of "".
	 * 
	 * @param name
	 *            The name of the node.
	 * @param code
	 *            A JSoup Node (or Document, Element etc.) that contains the
	 *            HTML code.
	 */
	...
	/**
	 * The constructor used for document nodes. It reads the HTML code from the
	...
	public NamedNode(String path) {
		...
		try {
			...
			throw new BadCodeException(
					"File " + path + " could not be read.  (This does not necessarily mean it was bad code).");
		}
	}
